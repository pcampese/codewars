...
def solution(n):
	...
	# for n in xrange(1, 100+1):		# This for loop is just for testing all the numbers.  Remove this from the for loop later
	...
	print('roman_blueprint = {}'.format(roman_blueprint))
